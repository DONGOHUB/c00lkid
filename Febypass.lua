local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/natoloe009/SCRIPT-ROBLOX/main/kavo%20mobile.txt"))()
local Window = Library.CreateLib("DARK HUB", "Sentinel")
